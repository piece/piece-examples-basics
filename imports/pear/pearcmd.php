 ...
 * @nodep Gtk
 */
if ('C:\cygwin\home\iteman\SVNWORK\piece-examples\basics\imports\pear' != '@'.'include_path'.'@') {
    ini_set('include_path', 'C:\cygwin\home\iteman\SVNWORK\piece-examples\basics\imports\pear');
    $raw = false;
} else {
