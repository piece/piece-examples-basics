...
FOR %%x IN ("C:\cygwin\home\iteman\SVNWORK\piece-examples\basics\imports\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\cygwin\home\iteman\SVNWORK\piece-examples\basics\imports\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\cygwin\home\iteman\SVNWORK\piece-examples\basics\scripts"
